...
void ofApp::setup()
{
    ...
    // the output from a matrix expression.  So don't do this:
    //
    //     auto x = inv(M)*y;
    //
    ...
    std::cout << "sum of all elements in M is " << M_sum << std::endl;
    ...
    std::cout << "sum of all elements in M is " << sum(M) << std::endl;
