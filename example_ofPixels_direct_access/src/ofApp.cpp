...
void ofApp::draw()
{
    ...
    ofDrawBitmapStringHighlight("shortPix", 14, 14);

    ofTranslate(w, 0);
    shortPixBlurredTexture.draw(0, 0);
    ofDrawBitmapStringHighlight("shortPixBlurred", 14, 14);
    ofPopMatrix();

    ofPushMatrix();
    ofTranslate(0, h + h);
    floatPixTexture.draw(0, 0);
    ofDrawBitmapStringHighlight("floatPix", 14, 14);

    ofTranslate(w, 0);
    floatPixBlurredTexture.draw(0, 0);
    ofDrawBitmapStringHighlight("floatPixBlurred", 14, 14);
    ofPopMatrix();
