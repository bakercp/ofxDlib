...
//    dlib::of_image<dlib::rgb_pixel> wrapped_blurred_img(emptyPixels);

//    dlib::gaussian_blur(img, wrapped_blurred_img, 3);
...
//    grayTexture.loadData(gray);
    ...
    emptyTexture.loadData(emptyPixels);
